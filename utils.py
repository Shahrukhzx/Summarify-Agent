...
def chunked_summarize(text:str,summarize_func,max_chunk_size:int =2000) -> str:
    ...
    and then combining those summaries into a full summary.
    ...
    :return : A single string containing a combined summary
    """
    ...
    # run a final summmarization step on the combined partial summaries
